...
class PolicyTrainer(Trainer):
    ...
    def train_and_evaluate(self, train_prompts, eval_prompts, base_policy, preference_model, markov_decision_process, kl_budget=2.0):
        """
        ...
        eval_dict = {'train': None, 'test': None, 'kl': None, \
                     'win_rate_train': win_rate_train, 'win_rate_test': win_rate_ood, 'cvar_win_rate_train': None, \
                        'cvar_win_rate_test': None}
    ...
    def _win_rate_eval(self, trajectory_pairs, optimal_actions, markov_decision_process):
        actions = base_policy.act(prompts)
        triples = (prompts, optimal_actions, actions)
        prefs, _, _, _ = markov_decision_process.generate_gt_preferences(trajectory_pairs)
