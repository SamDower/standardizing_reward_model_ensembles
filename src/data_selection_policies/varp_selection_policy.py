...
class VarPSelectionPolicy(DataSelectionPolicy):
    def select_data(self, dataset, preference_model, batch_size):
        ...
        data = dataset.samples
        _, pref_probs, _, _, pref_probs_samples = preference_model.generate_preferences(data, use_standardizer=True, use_table=True, use_set_mag=False)
