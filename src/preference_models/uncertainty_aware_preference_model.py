from preference_models import PreferenceModel
import torch
import numpy as np
import gc

class UncertaintyAwarePreferenceModel(PreferenceModel):
    ...
    def eval(self, train_data, eval_data, markov_decision_process):
        """
        ...
        with torch.no_grad():
            ...
            eval_dict = {
                ...
                'full_data': (self.full_data[0].cpu(), self.full_data[1].cpu()),
    ...
    def _build_data_stats(self):
        trajectories1, trajectories2 = self.full_data[0], self.full_data[1]
