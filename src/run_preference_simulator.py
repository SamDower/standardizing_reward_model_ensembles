...
from simulators import PreferenceOptimizationSimulator
...
def main():
    ...
    uncertainty_aware_preference_model = from_class(config['pref_model']['class'])(device, reward_standardizer, **config['pref_model'])
    ground_truth_preference_model = None # from_class(config['gt_pref_model']['class'])(config['gt_pref_model'], device=device)
    ...
    simulator = PreferenceOptimizationSimulator(
        ...
        policy,
        reward_standardizer,
        uncertainty_aware_preference_model,
        ground_truth_preference_model,
        policy_trainer,
        config['exp_name'],
        seed
    )
